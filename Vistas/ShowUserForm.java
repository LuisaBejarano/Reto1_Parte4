...
public class ShowUserForm extends javax.swing.JDialog {
    ...
    public void recibeDatosUserMenu(int idEmp, String nombres, String apellidos, String tipoDoc, String documento, String correo ){
        System.out.println(idEmp + " " + nombres + " " + documento + " " + correo);
        txtId.setText("" + idEmp);
    ...
    public void ActualizarEmpleado(){
        ...
        if(nombres.isEmpty()){
          JOptionPane.showMessageDialog(this, "El campo nombre del empleado es requerido", "", JOptionPane.WARNING_MESSAGE);
        }else if(apellidos.isEmpty()){
           JOptionPane.showMessageDialog(this, "El campo apellidos del empleado es requerido", "", JOptionPane.WARNING_MESSAGE); 
        }else if(correo.isEmpty()){
            JOptionPane.showMessageDialog(this, "El campo correo del empleado es requerido", "", JOptionPane.WARNING_MESSAGE);
        }else{
            ...
            try{
                ...
                JOptionPane.showMessageDialog(this, "No se pudo actializar el usuario.", "", JOptionPane.ERROR_MESSAGE);
            }
            this.dispose();
        }
    }
    ...
    private void initComponents() {
        ...
        btnRegresar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/back-icon.png"))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(txtTipoDocumento, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            ...
                            .addComponent(txtCorreo, javax.swing.GroupLayout.PREFERRED_SIZE, 498, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(59, 59, 59))
        );
